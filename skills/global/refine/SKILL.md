...
Then create the ticket with appropriate flags (typically `--summary`, `--description`,
`--type`, `--project`).
...
```bash
acli jira workitem edit PROJ-123 --description "[refined description]"
```
...
Write `.claude/artifacts/<TICKET>-ticket.md`:
